'''
    ...
    Extracts features from Original Train.csv (3GB) and Users.csv.
'''
import re
import pandas   as pd
import numpy    as np
...
chunksize = 200000
for data in pd.read_csv('train_complete.csv', chunksize=chunksize):
...
final_data.to_csv('train_complete_preprocessed.csv', index=False)
